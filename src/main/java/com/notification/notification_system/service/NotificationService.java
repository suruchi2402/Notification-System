...
//        this.senderFactory=senderFactory;
    ...
    public Notification createNotification(NotificationRequest request){
        ...
        event.setId(savedNotification.getId());
        event.setSubject(savedNotification.getSubject());
        event.setRecipient(savedNotification.getRecipient());
        event.setMessage(savedNotification.getMessage());
        event.setChannel(savedNotification.getChannel());
